    ...
    async constructor( languageCode )
    {
        ...
        if ( file )
        {
            ...
            if ( await moveFile( sourceFilePath, mediaFilePath ) )
            {
                ...
                {
                    await this.processJpegImage( mediaFilePath, targetFilePath );
                }
                else if ( hasSuffix( targetFilePath, '.png' ) )
                {
                    await this.processPngImage( mediaFilePath, targetFilePath );
                }
                else
                {
                    await moveFile( mediaFilePath, targetFilePath );
                }
